...
CREATE TABLE space_events (
    ...
    FOREIGN KEY (event_id) REFERENCES event_types(event_id) ON DELETE CASCADE,
    FOREIGN KEY (space_id) REFERENCES venue_spaces(space_id) ON DELETE CASCADE
);
...
CREATE TABLE capacity (
    ...
    space_event_id INT,
    max_capacity INT,
    FOREIGN KEY (space_event_id) REFERENCES space_events(space_event_id) ON DELETE CASCADE
);
