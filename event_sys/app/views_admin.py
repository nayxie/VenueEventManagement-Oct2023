                ...
                for selected_service in new_selected_service_list:
                    ...
                    # else:
                        ...
                        if id == selected_service[0]:
                            service_id = int(id)
                            service_price = float(selected_service[1]) if selected_service[1] else 0.0
                            if service_id == 1:
                                pricing_model = 'PerHead'
                            else:
                                pricing_model = 'Fixed'
...
def admin_space_information_edit(venue_id):
    ...
    if (request.method == 'POST'
        ...
        #print(venue_id) Debugging
        #print(space_name) Debugging
        #print(space_id) Debugging
        #print(max_capacity) Debugging
        #print(new_event_options) # might be None (empty list), or ['4', '5'] Debugging
        #print(equipment) Debugging
